...
#define MAX_TRANSDUCERS 11 // Maximum number of transducers per node
#define MAX_NODES 100 // Maximum number of nodes
#define MAX_TYPES 12 // Maximum number of different types of nodes
#define MAX_STRING_SHORT 8
#define MAX_STRING_LONG 64
#define MAX_STRING_VLONG 512

#define NONBLOCKING  0
#define BLOCKING     1
#define SLIP_KEEP_ALIVE_PERIOD 10000000

#define SAGA_DELAY 3000000
#define REFRESH 1000	// Refresh rate in µs
