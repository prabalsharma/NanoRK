...
void print_usage ()
{
  ...
  printf ("  Ex: config-eeprom /dev/ttyUSB1 1234beef 25 00112233445566778899AABBCCDDEEFF -v FF3\n");
  ...
  printf ("  FireFlyVersion   FF3 (default) or FF2 to switch between avrdude options\n");
  exit (-1);
}
